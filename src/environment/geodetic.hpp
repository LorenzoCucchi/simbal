...
public:
  ...
  double get_radiusE() { return radiusE; }
...
private:
  ...
  const double k = 1.931852652458e-03; // [-]     Somigliana’s Formula - normal
  ...
  const double m = 3.449786506841e-03;  // [-]     Normal gravity formula
